...
public class Main {
    public static void main(String[] args) {
        ...
        airConditionerController.airconpoweronoff();
        airConditionerController.onSetTemparatureDownButton();
        airConditionerController.onSetTemparatureUpButton();
        airConditionerController.SetTemparatureDownButton();
        airConditionerController.SetTemparatureUpButton();
        airConditionerController.airconpoweronoff();
    }
}
