...
/*
    배열의 필요성 :
        ...
        참조 변수 : 데이터가 위치한 주소값을 가지는 변수로 해당 주솔르 통해서 데이터에 접근하여 값을 가져오거나
            변경하는 경우
...
//        int j = 10;
        ...
        // 3. 번과제에서 확인할 수 있듯이 각 element들은 그 자료형에 따라 수학적인 연산 혹은
        // 기타 다른 작업을 할 수 있습니다.
        System.out.println();
        arr04[0] += 1;
        ...
        for( int i = 0 ; i < arr05.length ; i++) {
            System.out.println((i+1) + " : " + arr05[i]);
        }
    }
}