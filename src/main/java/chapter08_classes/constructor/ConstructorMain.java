...
public class ConstructorMain {
    public static void main(String[] args) {
        // 기본 생성자를 통한 인스턴스 생성
        Constructor constructor0 = new Constructor(10, "김일");
