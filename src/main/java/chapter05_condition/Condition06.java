...
//        System.out.println("changedScore : " + changedScore);
        ...
        if (score < 0 || score > 100) {
            System.out.println("학점은 X 학점 입니다.");
        } else {
            // 여기서부터 switch문을 작성
            switch (changedScore) {
                case 10:
                    System.out.println("학점은 A 학점 입니다.");
                    break;
                case 9:
                    System.out.println("학점은 A 학점 입니다.");
                    break;
                case 8:
                    System.out.println("학점은 B 학점 입니다.");
                    break;
                case 7:
                    System.out.println("학점은 C 학점 입니다.");
                    break;
                case 6:
                    System.out.println("학점은 D 학점 입니다.");
                    break;
                default:
                    System.out.println("학점은 F 학점 입니다.");
                    break;
            }
        }
